...
export class Workbench {
  ...
  private async activate() {
    ...
    if (item.id === "origin") {
      ...
      this.status = "OpenRouter key saved in macOS Keychain. Restart to use it; OPENROUTER_API_KEY takes precedence when set."; return;
